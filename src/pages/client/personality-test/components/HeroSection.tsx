...
const StepItem = ({ title, description, image, numberStep }: StepItemProps) => {
  return (
    <div className='relative w-full md:max-w-[320px] bg-white rounded-[8px] shadow-[0_4px_18px_0_#00000040] overflow-hidden flex flex-col gap-2 items-start p-4'>
      <div className='absolute top-0 left-0 w-full h-[4px] bg-gradient-to-r from-salmon to-yellow' />
      <div className='flex w-full justify-end mb-[-40px]'>
...
const HeroSection = () => {
  return (
    <div className='mb-[50px]'>
      <div className='relative mb-[110px] md:mb-[50px]'>
        <svg
      ...
      <Container className='flex flex-col md:flex-row gap-4 w-full justify-center items-center'>
        {stepsPersonalityTest.map((item) => (
          <StepItem key={item.numberStep} {...item} />
        ))}
      </Container>
    </div>
  )
