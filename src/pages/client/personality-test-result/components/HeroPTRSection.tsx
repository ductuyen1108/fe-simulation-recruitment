  ...
  return (
    <div className='w-full py-6 md:py-0 flex flex-col justify-center items-center gap-6'>
      <div className='md:hidden flex items-center gap-2'>
        ...
        <Button className='px-4 py-2 max-w-[270px] w-full rounded-[36px] text-xs  font-semibold'>完全ロック解除</Button>
      </div>
      <div className='py-2 bg-gradient-to-r from-salmon to-yellow w-full flex items-center justify-center'>
        <img
          src='/assets/personality-test-result/hero_illustration.svg'
          alt='hero-personality-test-result-illustration'
        />
      </div>
    </div>
  )
