      ...
      <Container>
        <div className='w-full grid grid-cols-1 md:grid-cols-2 items-center justify-between'>
          <img
            ...
            className='md:max-w-[550px] w-full h-auto'
          />
          <div className='flex flex-col items-center justify-center md:items-start md:justify-start gap-6 md:max-w-[560px]'>
            <div className='flex flex-col gap-5'>
              <span className='text-yellow '>性格タイプ</span>
