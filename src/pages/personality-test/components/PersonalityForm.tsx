  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-10 py-16'>
      {pageIndex > 0 && (
        ...
        >
          <div className='flex items-center gap-3 font-sans text-neutral-600 cursor-pointer' onClick={handlePrev}>
          ...
          <div className='flex items-center gap-3 w-fit '>
            ...
            <span className='hidden md:block text-neutral-600 font-sans'>
        ...
        <div className='mx-auto w-full max-w-[820px] p-6 rounded-[8px] space-y-6 shadow-[2px_4px_18px_0px_#00000040]'>
          ...
          <div className='flex flex-col gap-2'>
            <label className='flex items-center gap-3'>
              ...
              <span className='text-[14px] leading-5 font-sans text-neutral-600'>男</span>
            </label>
            <label className='flex items-center gap-3'>
              <input type='radio' className='w-[22px] h-[22px]' name='gender' value='female' />
              <span className='text-[14px] leading-5 font-sans text-neutral-600'>女性</span>
            </label>
            <label className='flex items-center gap-3'>
              <input type='radio' className='w-[22px] h-[22px]' name='gender' value='other' />
              <span className='text-[14px] leading-5 font-sans text-neutral-600'>他の</span>
            </label>
          </div>
