import { tGlobal } from '@/common/utils/i18n'
import { useMemo } from 'react'
import { NavLink, useLocation } from 'react-router-dom'

const tabs = [
  { label: tGlobal('header.personalityTest'), link: '' },
  { label: tGlobal('header.personalityType'), link: '/personality-test' },
  { label: tGlobal('header.suitability'), link: '/suitability-test' }
]
