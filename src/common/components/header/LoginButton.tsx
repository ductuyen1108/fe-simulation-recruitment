          ...
          <div className='flex flex-col mt-4 gap-6'>
            ...
            <div className='space-y-4'>
              <TextField
                ...
                label={<p className='font-sans font-semibold text-xs text-neutral-600'>あなたの性格タイプの詳細</p>}
              ...
              <TextField
                ...
                placeholder='********'
                register={register}
                label={<p className='font-sans font-semibold text-xs text-neutral-600'>パスワード</p>}
            ...
            <div className='flex items-center justify-between'>
              <span className='text-xs text-[#26A9F1] font-semibold font-sans cursor-pointer'>パスワード</span>
              <span className='text-xs text-[#26A9F1] font-semibold font-sans cursor-pointer'>
                パスワードをお忘れですか？
              </span>
            </div>
          </div>
